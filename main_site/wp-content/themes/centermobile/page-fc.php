    ...
    <section class="partner" id="franchise">
      <div class="wrapper">
        ...
        <div class="partner_inner partner_content">
          <picture class="fc1">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/fc1.webp" type="image/webp">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/fc1.png" alt="" width="490" height="165">
          </picture>
        ...
        <div class="partner_inner">
          ...
          <p class="indent">センターモバイルは通信インフラ事業の中でも新世代格安スマホとして、今までの常識に一石を投じ、新しい提案での問題解決を目指します。</p>
        </div>
        ...
        <div class="partner_inner">
          ...
          <ul class="pr_lists">
            <li>
              <picture class="image">
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/fc2_1.webp" type="image/webp">
            ...
            <li>
              <picture class="image">
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/fc2_2.webp" type="image/webp">
            ...
            <li>
              <picture class="image">
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/fc2_3.webp" type="image/webp">
            ...
            <li>
              <picture class="image">
                <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/fc2_4.webp" type="image/webp">
    ...
    <section class="partner" id="oem">
      <div class="about_cm">
        <p><span>センターモバイルのOEMとは</span><br><br>センターモバイルのサービスを自社のサービスにリブランディングし販売する事を指します。<br>
          <br>最大割引で0円の通信事業を自社のサービスとして展開することができます。
        </p>
      </div>
      ...
      <div class="wrapper">
        ...
        <div class="partner_inner">
          <picture class="image">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/img/oem.webp" type="image/webp">
