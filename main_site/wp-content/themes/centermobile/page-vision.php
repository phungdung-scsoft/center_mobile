...
<body>
  ...
  <div class="section-introduce main-container">
    ...
    <p class="introduce-desc">を行い、毎日いつも通りスマホを使っているだけで、携帯代が無料まで下がる仕組みを目指します。普段多くの方が使っている年間数万円の携帯代を0円にすることで、消費の活性化や貯蓄・投資の一助になる事を目指し、これからも精進いたします。</p>
    <div class="line"></div>
  </div>
  <div class="section-philo">
    ...
    <div class="philo-block">
      <div class="philo-content main-container">
        ...
        <h4 class="philo-text">
          <span>3</span>
          <p>先を見据えたサービスで社会インフラの可能性を広げ、<br>社会をより良くする</p>
        </h4>
      </div>
    </div>
  </div>
