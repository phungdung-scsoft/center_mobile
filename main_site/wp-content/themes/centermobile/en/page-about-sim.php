  ...
  <div class="page-about-sim">
    ...
    <div class="section-charge">
      <div class="main-container">
        ...
        <a href="https://sim.centermobile.co.jp/?utm_source=corporate" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/company/bnr_sim.png" alt="スマホが今より安くなる！？　詳しくはこちら" width="1200" height="628"></a>
      </div>
    </div>
  </div>
