<div class="hArea">
  ...
  <div class="header-pc pc-flex">
    ...
    <div class="hFunction">
      ...
      <a href="<?php echo esc_url(home_url('/')); ?>en/contact-top/" class="hBtn">Contact Us</a>
    </div>
  </div><!-- /header -->
  ...
  <div class="header-sp sp">
    <div class="header-main">
      <a href="<?php echo esc_url(home_url('/')); ?>en/" class="hLogo">
    ...
    <div class="gnav">
      <div class="gnav__wrap">
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>en/contact-top/" class="hBtn">Contact Us</a>
        <button class="closeBtn"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/close_icon.svg" alt="close">CLOSE</button>
      </div>
