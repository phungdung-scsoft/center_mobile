      ...
      <section class="point">
        <div class="wrapper">
          ...
          <ul class="capList">
            ...
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_discount_2.png" alt="" width="300" height="643"></div>
              <div class="detail">
                <p>「CMを見る！」ボタンを押すと動画広告が再生されます。(※1)</p>
              </div>
            </li>
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_discount_3.png" alt="" width="300" height="643"></div>
              <div class="detail">
            ...
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_discount_4_2.png" alt="" width="300" height="643"></div>
              <div class="detail">
                <p>1ポイント獲得となります。</p>
