      ...
      <section class="point">
        <div class="wrapper">
          ...
          <ul class="capList mb-30">
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_1.png" alt="" width="294" height="529"></div>
              <div class="detail">
                <p>貯めたポイント数が確認できます。</p>
              </div>
            </li>
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_2.png" alt="" width="294" height="529"></div>
              <div class="detail">
                <p>ポイントの履歴が確認できます。</p>
              </div>
            </li>
          ...
          <ul class="capList mb-30">
            <li>
              <div class="cap">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_3_2.png" alt="" width="294" height="529">
              </div>
              <div class="detail">
                <p>今月のご利用料金が確認できます。</p>
              </div>
            ...
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_4.png" alt="" width="294" height="529"></div>
              <div class="detail">
                <p>過去のご利用料金が確認できます。</p>
              </div>
            </li>
          ...
          <ul class="capList">
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_5.png" alt="" width="294" height="529"></div>
              <div class="detail">
                <p>今月のデータが確認できます。</p>
              </div>
            </li>
            <li>
              <div class="cap"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/cap_app_6.png" alt="" width="294" height="529"></div>
              <div class="detail">
                <p>ギガの追加購入ができます。</p>
              </div>
            </li>
