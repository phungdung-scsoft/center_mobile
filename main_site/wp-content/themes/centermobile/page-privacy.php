...
<body>
  <div id="content">
    <h1>プライバシー・ポリシー</h1>
    <p>株式会社センターモバイル（以下，「当社」といいます。）は，本アプリ上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
    ...
    <ol>
      ...
      <li>動画広告、成果報酬型広告、ターゲディング広告など、当社が行っている広告配信のため</li>
    ...
    <p>住所：大阪府大阪市中央区久太郎町1-5-31 リアライズ堺筋本町ビル507<br>社名：株式会社センターモバイル</p>
  </div>
  <?php wp_footer(); ?>
</body>
