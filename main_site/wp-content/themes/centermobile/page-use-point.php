...
<body>
  <div id="content">
    ...
    <p>本サービスを利用する会員は、当社が定める方法により保有するポイントを<?php echo ($gl_point) ? '1' : '10'; ?>ポイント1円相当分として明細料金の割引に使うことができます。</p>
    <?php if (!$gl_point) : ?>
      <p>ご利用ポイント数は10ポイント単位でご利用いただけます。11ポイントや12ポイントではご利用いただけませんのでご注意ください。</p>
    <?php endif; ?>
    <p>ポイントには有効期限はありません。</p>
    <p>本サービスから得たポイントは、当月分の明細料金に利用することができます。過去の明細料金には利用することができません。</p>
